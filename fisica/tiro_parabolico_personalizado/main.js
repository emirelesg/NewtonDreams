...
function drawBallLabels() {
  for (var i = 0; i < steps; i++) {
    ...
    if (b.obj.display && b.obj.position.x !== 0) {
      ball_labels.text("Vy: " + p$.utils.round(b.vy, 1) + " m/s", b.obj.position.x, b.obj.position.y + 8);
      ball_labels.text(p$.utils.round(b.time, 1) + " s", b.obj.position.x, b.obj.position.y + 12);
    }
  }
}
