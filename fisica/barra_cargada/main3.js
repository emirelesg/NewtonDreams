...
var results = new p$.Box( { debug: false, title: "Resultados", display: true, isDraggable: true } );
...
function setupControls() {
  ...
  controls.sections = new p$.Slider({ id: "sections", start: 10, min: 1, max: 100, decPlaces: 0, units: "", callback: reset });
...
function drawBar() {
  ...
  var nSteps = controls.sections.value;                   // Amount of integration sections.
